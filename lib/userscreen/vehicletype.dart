...
import 'package:spotquick/custom%20widgets/vehicletypeinfo.dart';
import 'package:spotquick/userscreen/detail.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(child: Text('Vehicle Type',style: TextStyle(color: Colors.white),)),
      ),
      body: Align(
